...
# Agrega o quita usuarios aquí. Formato: "usuario": "contraseña"
USUARIOS = {
    "mama":    "clave123",
    "papa":    "clave456",
    "hermano": "clave789",
...
<div class="card">
  ...
  <div class="apps">
    ...
    <div class="app-chips">
      ...
      <span class="chip">IPTV Smarters</span>
...
async function generar() {
  ...
  if (res.ok) {
    const url = `${BASE}/lista?user=${encodeURIComponent(user)}&pass=${encodeURIComponent(pass)}`;
...
def lista():
    ...
    try:
        ...
        return Response(contenido, mimetype="application/x-mpegurl",
                        headers={"Content-Disposition": "inline; filename=tv_favorito.m3u"})
